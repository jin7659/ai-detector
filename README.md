...
- **[안정성] MCP SDK 호환성 패치**: 최신 MCP SDK의 스키마 변경에 대응하여 `setRequestHandler`의 핸들러 등록 방식을 최신화했습니다.
- **[안정성] 모델 교체**: 허깅페이스 접근 권한 이슈가 있던 모델에서 가장 신뢰도 높은 `Xenova/roberta-base-openai-detector`로 교체하여 안정성을 확보했습니다.
